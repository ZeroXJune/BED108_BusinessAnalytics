...
| CP4 — Predictive & Defense | Final | [Spec](docs/Checkpoint_4_Spec.docx) · [Ethics](docs/Checkpoint_4_Ethics.docx) · [Deck](reports/Capstone_Defense_Deck.pptx) · [Model output](reports/predictive_model_results.md) — Tasks 4.1, 4.2 and the deck done |
